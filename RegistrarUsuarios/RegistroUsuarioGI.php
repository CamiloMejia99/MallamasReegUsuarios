                              ...
                              <div class="card bg-transparent " style="width: 18rem;">
                                    <div class="card-body">
                                          <div class="alert alert-success border-dark text-black" role="alert">
                                                <B>REGISTRO PERSONAL USUARIOS GESTION MATRIZ DE INDICADORES</B>
                                          </div>
                                          <form class="row g-3" name="nuevo usuario" method="POST" action="../php/ConexionCrearUsuarioGI.php">
                                                <table class="table table-success table-striped">
                                                      ...
                                                      <tr align="center" valign="middle">
                                                            ...
                                                            <td>
                                                                  <input type="text" name="codigoUsuario" placeholder="Nombre de Usuario" class="form-control" id="validationDefault05" required>
                                                            </td>
                                                            <td>
                                                                  Correo:
                                                            </td>
                                                      ...
                                                      <tr align="center" valign="middle">
                                                            ...
                                                            <td>
                                                                  <input type="password" name="credencial" placeholder="Credencial" class="form-control" id="validationDefault05" required>
                                                            </td>
                                                      </tr>
                                                      <tr align="center" valign="middle">
                                                            <td>
                                                            ...
                                                            <td>
                                                                 <div class="input-group">
                                                                  <input type="password" id="password" name="contraseña" class="form-control" 
                                                                        placeholder="Contraseña" data-bs-toggle="tooltip" title="Debe tener mínimo 8 caracteres, mayúscula, número y símbolo" required>
                                                            ...
                                                            <td>
                                                                  <div class="input-group">
                                                                  <input type="password" id="confirm-password" name="repitecontraseña" class="form-control" 
                                                                        placeholder="Repite contraseña" data-bs-toggle="tooltip" title="Debe coincidir con la contraseña" required>
                                                      ...
                                                      <tr>
                                                            <td colspan="6">
                                                                  <div class="form-group">
                                                                        <label for="super_usuario">Activar Super Usuario:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input class="form-check-input" type="checkbox" name="super_usuario" id="super_usuario" value="1">
                                                                  </div>
                                                                <div class="alert alert-info border-dark text-black mt-3" role="alert">
                                                                    <b>Seleccione los procesos a los que tendrá acceso:</b>
                                                                </div>

                                                                <?php
                                                                include('../bd/conexion.php');
                                                                $query = sqlsrv_query($conexionGestionIndicadores, "SELECT idProceso, Proceso FROM Proceso");
                                                                if ($query) {
                                                                    while ($row = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)) {
                                                                        echo '
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" name="procesos[]" id="Proceso'.$row['idProceso'].'" value="'.$row['idProceso'].'">
                                                                            <label class="form-check-label" for="Proceso'.$row['idProceso'].'">'.$row['Proceso'].'</label>
                                                                        </div>';
                                                                    }
                                                                } else {
                                                                    echo '<p class="text-danger">Error al cargar los procesos.</p>';
                                                                }
                                                                ?>
                                                            </td>
                                                      </tr>
                                                      <tr align="center" valign="middle">
                                                            <td colspan="10">
                                                                  <button class="btn btn-success border-dark"  type="submit" name="enviar">ok</button>
                                                            </td>
                                                      </tr>
                                                      <br>
                                                      <table align="center">
